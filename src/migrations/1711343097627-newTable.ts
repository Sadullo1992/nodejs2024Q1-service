...
export class NewTable1711343097627 implements MigrationInterface {
  name = 'NewTable1711343097627';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "favs" ("id" character varying NOT NULL, "artists" uuid array NOT NULL DEFAULT '{}', "albums" uuid array NOT NULL DEFAULT '{}', "tracks" uuid array NOT NULL DEFAULT '{}', CONSTRAINT "PK_2fde25c80bd089c0fa0e7986409" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
